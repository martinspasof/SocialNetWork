            ...
            success: function(data, textStatus, xhr) {
                ...
                for (var i = 0; i < parseData.games.length; i++) {
                    ...
                    var srcPic = parseData.games[i].srcPic;
                        ...
                        if((name.match(rgx) != null) || searchedText.length == 0) {
                            userContainer = document.createElement("div");
                            userContainer.className = "user-container";

                            $("#users").append(userContainer);

                            $(".user-container:last-child").append("<div>" + "<a href='#'>" + name + "</a>" + "</div>");
                            $(".user-container:last-child").append("<div>" + "<a href='#'>" + info + "</a>" + "</div>");
                            $(".user-container:last-child").append("<img src='../images/" + srcPic + "' width='120px' height='100px'>");
                        }
                }
